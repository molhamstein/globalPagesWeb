...
let ForgetPasswordComponent = class ForgetPasswordComponent {
    ...
    submit(data) {
        if (this.form.valid)
            this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api + 'users/forgotPassword', data).toPromise().then((data) => {
...
let LogInComponent = class LogInComponent {
    ...
    submit(form) {
        ...
        if (form.invalid)
            return;
        let data = form.value;
        this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api + 'users/login', data).subscribe((data) => {
...
let ResetComponent = class ResetComponent {
    ...
    submit(data) {
        if (this.form.valid)
            this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api + 'users/resetPassword', data).toPromise().then((data) => {
            });
    }
};
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let SignUpComponent = class SignUpComponent {
    ...
    submit(data) {
        ...
        if (!this.form.invalid) {
            this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api + 'users', data).toPromise().then((data1) => {
                this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api + 'users/login', { email: data["email"], password: data["password"] }).toPromise().then((data2) => {
