                                ...
                                mouseover: function() {
                                    $(this).gmap3({
                                        overlay:{
                                            address:val.address,
                                            options:{
                                                content:  "<div class='infobox'><div class='logo'>D</div><div class='text'><h3>Al-Mersal</h3><p>31 Ven HoVan Chuong Street,<br />Ha Noi, Viet Nam</p></div><div class='clearfix'></div></div>",
                                                offset:{
                                                    y:-200,
                                                    x:-115
                                                }
                    ...
                    for (i = 0; i < filesAmount; i++) {
                      $('#preview-box').html('');
                        ...
                        reader.onload = function(event) {
                          var fileDiv = "<div class='imagebox col-md-3'><img src='"+event.target.result+"' /><span class='delete'><i class='fa fa-times-circle' aria-hidden='true'></i></span></div>";

                          $('#preview-box').append(fileDiv);
                        }
