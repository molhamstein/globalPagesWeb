...
var AdDataResolverService = /** @class */ (function () {
    ...
    AdDataResolverService.ctorParameters = function () { return [
...
var AdViewComponent = /** @class */ (function () {
    ...
    AdViewComponent.ctorParameters = function () { return [
...
/* harmony import */ var _angular_flex_layout__WEBPACK_IMPORTED_MODULE_63__ = __webpack_require__(/*! @angular/flex-layout */ "./node_modules/@angular/flex-layout/esm5/flex-layout.es5.js");
...
var AddJobOpportunityComponent = /** @class */ (function () {
    ...
    AddJobOpportunityComponent.ctorParameters = function () { return [
...
var EditJobOpportunityComponent = /** @class */ (function () {
    ...
    EditJobOpportunityComponent.ctorParameters = function () { return [
...
var GuideCardComponent = /** @class */ (function () {
    ...
    GuideCardComponent.ctorParameters = function () { return [
        { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var GuideComponent = /** @class */ (function () {
    function GuideComponent(ts, cds, requests, resolver, injector, route, router) {
        this.ts = ts;
        this.cds = cds;
    ...
    GuideComponent.prototype.ngOnInit = function () {
        var _this = this;
        var filter = this.getQueryParams();
        this.cds.citiesPromise.then(function (res) { return _this.cities = res; });
    ...
    GuideComponent.prototype.getQueryParams = function () {
    ...
    GuideComponent.prototype.addQueryParams = function (param) {
        this.router.navigate([], {
            queryParams: tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, param),
        });
    };
...
var JobCardComponent = /** @class */ (function () {
    ...
    JobCardComponent.ctorParameters = function () { return [
        { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
...
var JobsComponent = /** @class */ (function () {
    function JobsComponent(cds, requests, route, router) {
        this.cds = cds;
        this.requests = requests;
        this.route = route;
        this.router = router;
    ...
    JobsComponent.prototype.getQueryParams = function () {
        var params = this.route.snapshot.queryParams;
        var filter = "?status=activated&";
    ...
    JobsComponent.prototype.addQueryParams = function (param) {
        this.router.navigate([], {
            queryParams: tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, param),
        });
    };
...
var MapMarkerComponent = /** @class */ (function () {
    ...
    MapMarkerComponent.ctorParameters = function () { return [
        { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
...
var AddProductComponent = /** @class */ (function () {
    function AddProductComponent(api, translteService, router, spinner, auth, dialog) {
        this.api = api;
        this.translteService = translteService;
        this.router = router;
        this.spinner = spinner;
    ...
    AddProductComponent.prototype.ngOnInit = function () {
        ...
        this.api.get('productCategories', params).toPromise().then(function (data) {
            _this.categories = data;
        });
        this.api.get('cities').toPromise().then(function (data) {
            _this.cities = data;
        ...
        this.auth.userData.subscribe(function (data) {
            var filter = { "where": { "ownerId": data['id'] } };
            _this.api.get('businesses?filter=' + JSON.stringify(filter)).toPromise().then(function (res) {
                _this.allBusiness = res;
            });
        });
    };
    AddProductComponent.prototype.submit = function (data) {
        var _this = this;
        this.spinner.show();
        data['categoryId'] = this.categories[this.selectedCategory]['id'];
        var user = JSON.parse(localStorage.getItem(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].userDetails));
        ...
        if (this.files && this.files.length > 0) {
            ...
            this.api.post('attachments/images/upload', images).subscribe(function (res) {
                ...
                _this.api.post('marketProducts/addProduct', data).subscribe(function (data) {
                    _this.spinner.hide();
            ...
            this.api.post('marketProducts/addProduct', data).subscribe(function (data) {
                _this.spinner.hide();
                _this.router.navigate(['products']);
            });
        }
    };
    AddProductComponent.prototype.onCategoryChange = function () {
        this.subCategoryId = null;
        this.subCategories = this.categories[this.selectedCategory]['subCategories'];
    };
    AddProductComponent.prototype.cityChanged = function () {
        var _this = this;
        this.locationId = null;
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpParams"]();
        params = params.set('filter', JSON.stringify({
        ...
        this.locations = [];
        this.api.get('locations', params).toPromise().then(function (data) {
            _this.locations = data;
        });
    };
    AddProductComponent.prototype.typeing = function (event) {
        var value = event.target.value;
        var self = this;
        setTimeout(function () {
            if (self.inputValue == value) {
    ...
    AddProductComponent.prototype.addTag = function (tag) {
        var isFind = false;
        this.tags.forEach(function (element) {
            if (element.id == tag.id) {
                isFind = true;
    ...
    AddProductComponent.prototype.removeTag = function (index) {
        var self = this;
        var dialogRef = this.dialog.open(src_app_verification_message_verification_message_component__WEBPACK_IMPORTED_MODULE_9__["VerificationMessageComponent"], {
            //   width: '70%',
            panelClass: 'communictioDialogStyle',
            data: { "message": "deleteSkill" }
        });
    ...
    AddProductComponent.prototype.addNewTag = function () {
        var value = this.inputValue;
        this.inputValue = "";
        var self = this;
        if (value != "")
    ...
    AddProductComponent.prototype.foucasOut = function () {
        var self = this;
        setTimeout(function () {
            self.inputFocus = true;
        }, 200);
...
var EditProductComponent = /** @class */ (function () {
    function EditProductComponent(api, auth, spinner, router, route, dialog) {
        this.api = api;
        this.auth = auth;
        this.spinner = spinner;
        this.router = router;
    ...
    EditProductComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            _this.id = params.id;
            _this.api.get('marketProducts/' + _this.id).subscribe(function (res) {
                _this.product = res;
                _this.images = _this.product.media;
                _this.tags = _this.product.tags;
                _this.onCategoryChange();
                _this.cityChanged();
            });
        });
    };
    EditProductComponent.prototype.submit = function (data) {
        var _this = this;
        this.spinner.show();
        var user = JSON.parse(localStorage.getItem(src_environments_environment__WEBPACK_IMPORTED_MODULE_9__["environment"].userDetails));
        data['ownerId'] = user['userId'];
        data['tags'] = [];
        for (var _i = 0, _a = this.tags; _i < _a.length; _i++) {
            var tag = _a[_i];
        ...
        if (this.files && this.files.length > 0) {
            ...
            this.api.post('attachments/images/upload', formData).subscribe(function (res) {
                for (var i = 0; i < res.length; i++) {
                    _this.images.push(res[i].url);
                }
                data['media'] = _this.images;
                _this.api.put('marketProducts/' + _this.id + '/updateProduct', data).subscribe(function (data) {
                    _this.spinner.hide();
                    _this.router.navigate(['products']);
                }, function (err) {
                    _this.spinner.hide();
            ...
            this.api.put('marketProducts/' + this.id + '/updateProduct', data).subscribe(function (data) {
                _this.spinner.hide();
                _this.router.navigate(['products']);
            }, function (err) {
                _this.spinner.hide();
    ...
    EditProductComponent.prototype.onCategoryChange = function () {
        var _this = this;
        if (this.categories != null) {
            var cat = this.categories.find(function (v) { if (v['id'] == _this.product['categoryId'])
                return true; });
            this.subCategories = cat['subCategories'];
        }
    };
    EditProductComponent.prototype.cityChanged = function () {
        var _this = this;
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]();
        params = params.set('filter', JSON.stringify({
            where: {
    ...
    EditProductComponent.prototype.typeing = function (event) {
        var value = event.target.value;
        var self = this;
        setTimeout(function () {
            if (self.inputValue == value) {
    ...
    EditProductComponent.prototype.addTag = function (tag) {
        this.tags.forEach(function (element) {
            if (element.id == tag.id) {
                // already exist   
                return;
    ...
    EditProductComponent.prototype.removeTag = function (index) {
        var self = this;
        var dialogRef = this.dialog.open(src_app_verification_message_verification_message_component__WEBPACK_IMPORTED_MODULE_5__["VerificationMessageComponent"], {
            panelClass: 'communictioDialogStyle',
            data: { "message": "deleteSkill" }
        });
        dialogRef.afterClosed().subscribe(function (result) {
    ...
    EditProductComponent.prototype.addNewTag = function () {
        var value = this.inputValue;
        this.inputValue = "";
        var self = this;
        if (value != "")
    ...
    EditProductComponent.prototype.foucasOut = function () {
        var self = this;
        setTimeout(function () {
            self.inputFocus = true;
        }, 200);
...
var ProductCardComponent = /** @class */ (function () {
    function ProductCardComponent(tr) {
        this.tr = tr;
        this.data = {};
    }
...
var ProductsComponent = /** @class */ (function () {
    function ProductsComponent(ts, cds, requests, resolver, injector, route, router) {
        this.ts = ts;
        this.cds = cds;
        this.requests = requests;
        this.resolver = resolver;
    ...
    ProductsComponent.prototype.ngOnInit = function () {
        ...
        var filter = this.getQueryParams();
        this.cds.citiesPromise.then(function (res) { return _this.cities = res; });
        this.cds.productCategoryPromise.then(function (res) { return _this.bCategories = res; });
        this.getPostsData(filter);
    };
    ProductsComponent.prototype.getQueryParams = function () {
        var params = this.route.snapshot.queryParams;
        var filter = {};
        if (params.title && params.title.trim().length != 0) {
    ...
    ProductsComponent.prototype.addQueryParams = function (param) {
        this.router.navigate([], {
            queryParams: tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, param),
        });
    };
    ProductsComponent.prototype.reFilter = function () {
        this.addQueryParams({
            title: this.title,
            cityId: this.cityId,
            location: this.location,
    ...
    ProductsComponent.prototype.getPostsData = function (params) {
        var _this = this;
        params['filter[where][status]'] = "activated";
        params['filter[limit]'] = "20";
        params['filter[skip]'] = (20 * this.skip).toString();
    ...
    ProductsComponent.prototype.setCityId = function (c) {
        if (c != undefined) {
            this.cityId = c['id'];
        }
    };
    ProductsComponent.prototype.setCategoryId = function (c) {
        if (c != undefined) {
            this.categoryId = c['id'];
        }
    };
    ProductsComponent.prototype.prev = function () {
        this.nextDisabled = false;
        this.skip += 1;
        this.reFilter();
    };
...
var ViewProductComponent = /** @class */ (function () {
    ...
    ViewProductComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.api.get('marketProducts/' + _this.data['id']).toPromise().then(function (res) {
                ...
                _this.data['price'] = res['price'];
                _this.data['tags'] = res['tags'];
                if (res["ownerId"] == userData['id'])
                    _this.isMyProduct = true;
                ...
                galleryRef.load(_this._albums);
                if (_this.tr.currentLang == 'ar') {
                    _this.data['title'] = res['titleAr'];
                    _this.data['description'] = res['descriptionAr'];
                    _this.data['area'] = res['city']['nameAr'];
                    _this.data['subArea'] = res['location']['nameAr'];
                    _this.data['category'] = res['category']['titleAr'];
                    _this.data['subCategory'] = res['subCategory']['titleAr'];
                }
                else {
                    _this.data['title'] = res['titleEn'];
                    _this.data['description'] = res['descriptionEn'];
                    _this.data['area'] = res['city']['nameEn'];
                    _this.data['subArea'] = res['location']['nameEn'];
                    _this.data['category'] = res['category']['titleEn'];
                    _this.data['subCategory'] = res['subCategory']['titleEn'];
                }
            });
        });
    };
    ViewProductComponent.prototype.deactive = function () {
        var _this = this;
        var self = this;
        var dialogRef = this.dialog.open(src_app_verification_message_verification_message_component__WEBPACK_IMPORTED_MODULE_8__["VerificationMessageComponent"], {
            panelClass: 'communictioDialogStyle',
            data: { "message": "deactiveJob" }
        });
        dialogRef.afterClosed().subscribe(function (result) {
            if (result) {
                _this.api.patch('marketProducts/' + _this.data['id'], { status: 'deactivated' }).toPromise().then(function (data) {
                    var dialogRef = self.dialog.open(src_app_success_message_success_message_component__WEBPACK_IMPORTED_MODULE_9__["SuccessMessageComponent"], {
                        panelClass: 'communictioDialogStyle',
...
var SuppliersComponent = /** @class */ (function () {
    function SuppliersComponent(ts, cds, requests, route, router) {
        this.ts = ts;
        this.cds = cds;
        this.requests = requests;
        this.route = route;
    ...
    SuppliersComponent.prototype.ngDoCheck = function () {
        // since our components are dynamic, we need to manually iterate over them and trigger
        // change detection on them.
        this.markers.forEach(function (entry) {
            entry.componentInstance.changeDetectorRef.detectChanges();
    ...
    SuppliersComponent.prototype.getQueryParams = function () {
        var params = this.route.snapshot.queryParams;
        var filter = {};
        if (params.title && params.title.trim().length != 0) {
            filter['filter[where][or][0][nameEn][like]'] = params.title;
    ...
    SuppliersComponent.prototype.onMapReady = function (map) {
        this.map = map;
    };
    SuppliersComponent.prototype.addQueryParams = function (param) {
        this.router.navigate([], {
            queryParams: tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, param),
        });
    };
    SuppliersComponent.prototype.reFilter = function () {
        this.addQueryParams({
            title: this.title,
            cityId: this.cityId,
            location: this.location,
    ...
    SuppliersComponent.prototype.getPostsData = function (params) {
        var _this = this;
    ...
    SuppliersComponent.prototype.setCityId = function (c) {
        if (c != undefined) {
            this.cityId = c['id'];
        }
    };
    SuppliersComponent.prototype.setCategoryId = function (c) {
        if (c != undefined) {
            this.categoryId = c['id'];
        }
    };
    SuppliersComponent.prototype.prev = function () {
        this.nextDisabled = false;
        this.skip += 1;
        this.reFilter();
    };
    SuppliersComponent.prototype.next = function () {
        if (this.skip > 0) {
            if (this.skip <= 1) {
                this.nextDisabled = true;
            }
...
var ViewJobComponent = /** @class */ (function () {
    ...
    ViewJobComponent.ctorParameters = function () { return [
...
var FeaturedAdsComponent = /** @class */ (function () {
    ...
    FeaturedAdsComponent.ctorParameters = function () { return [
        { type: _requests_service__WEBPACK_IMPORTED_MODULE_2__["RequestsService"] }
    ]; };
...
var HeaderWithSearchComponent = /** @class */ (function () {
    ...
    HeaderWithSearchComponent.ctorParameters = function () { return [
        { type: _common_data_service__WEBPACK_IMPORTED_MODULE_2__["CommonDataService"] }
    ]; };
...
var VolumeComponent = /** @class */ (function () {
    ...
    VolumeComponent.ctorParameters = function () { return [
        { type: _requests_service__WEBPACK_IMPORTED_MODULE_2__["RequestsService"] },
        { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__["TranslateService"] },
...
var AdsCardComponent = /** @class */ (function () {
    ...
    Object.defineProperty(AdsCardComponent.prototype, "setAd", {
        set: function (d) {
            this.ad = d;
...
var CategorySelectorComponent = /** @class */ (function () {
    ...
    CategorySelectorComponent.ctorParameters = function () { return [
        { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var EditBasicInformationComponent = /** @class */ (function () {
    ...
    EditBasicInformationComponent.ctorParameters = function () { return [
        { type: src_app_requests_service__WEBPACK_IMPORTED_MODULE_4__["RequestsService"] },
...
var EditSkillComponent = /** @class */ (function () {
    ...
    EditSkillComponent.ctorParameters = function () { return [
        { type: src_app_requests_service__WEBPACK_IMPORTED_MODULE_2__["RequestsService"] },
...
var ProfileViewComponent = /** @class */ (function () {
    function ProfileViewComponent(api, route, translteService, auth, router) {
        this.api = api;
        this.route = route;
        this.translteService = translteService;
        this.auth = auth;
    ...
    ProfileViewComponent.prototype.ngOnInit = function () {
        ...
        this.auth.userData.subscribe(function (data) {
            ...
            _this.api.get('jobOpportunities', p).toPromise().then(function (data) {
                _this.jobs = data;
            });
            _this.api.get('marketProducts', p).toPromise().then(function (data) {
                _this.products = data;
            });
        });
    ...
    ProfileViewComponent.prototype.navigateTo = function (url) {
...
var FormValidationMessageComponent = /** @class */ (function () {
    ...
    FormValidationMessageComponent.ctorParameters = function () { return [
        { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
...
var NotificationComponent = /** @class */ (function () {
    ...
    NotificationComponent.prototype.clickHandle = function (notification) {
        ...
        if (notification.data.adId)
            this.router.navigate(['ad', notification.data.adId]).then(function (_) { return notficationClicked(); });
        if (notification.data.marketProductId)
            this.router.navigate(['products', notification.data.marketProductId]).then(function (_) { return notficationClicked(); });
        if (notification.data.businessId)
            this.router.navigate(['business', notification.data.businessId]).then(function (_) { return notficationClicked(); });
        if (notification.data.jobId)
            this.router.navigate(['job', notification.data.jobId]).then(function (_) { return notficationClicked(); });
    };
...
var SuccessMessageComponent = /** @class */ (function () {
    ...
    SuccessMessageComponent.ctorParameters = function () { return [
        { type: src_app_requests_service__WEBPACK_IMPORTED_MODULE_1__["RequestsService"] },
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatDialogRef"] },
        { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_3__["MAT_DIALOG_DATA"],] }] }
    ]; };
...
var VerificationMessageComponent = /** @class */ (function () {
    ...
    VerificationMessageComponent.ctorParameters = function () { return [
        { type: src_app_requests_service__WEBPACK_IMPORTED_MODULE_1__["RequestsService"] },
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatDialogRef"] },
        { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_3__["MAT_DIALOG_DATA"],] }] }
    ]; };
